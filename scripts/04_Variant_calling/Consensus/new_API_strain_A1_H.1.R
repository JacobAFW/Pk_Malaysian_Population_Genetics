...
VCF <- read_tsv("/g/data/pq84/malaria/Pk_Malaysian_Population_Genetics/outputs/04_Variant_calling/consensus/new_API_strain_A1_H.1.tsv", col_names = TRUE) %>% 
  rename("CHROM" = "#CHROM") %>% 
...
ordered_VCF %>% 
  ...
  write_tsv("/g/data/pq84/malaria/Pk_Malaysian_Population_Genetics/outputs/04_Variant_calling/consensus/new_API_strain_A1_H.1_variant_names.tsv")