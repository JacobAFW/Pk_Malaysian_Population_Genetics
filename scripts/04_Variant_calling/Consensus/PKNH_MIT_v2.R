...
VCF <- read_tsv("/g/data/pq84/malaria/Pk_Malaysian_Population_Genetics/outputs/04_Variant_calling/consensus/PKNH_MIT_v2.tsv", col_names = TRUE) %>% 
  rename("CHROM" = "#CHROM") %>% 
...
ordered_VCF %>% 
  ...
  write_tsv("/g/data/pq84/malaria/Pk_Malaysian_Population_Genetics/outputs/04_Variant_calling/consensus/PKNH_MIT_v2_variant_names.tsv")