...
ggsave("/g/data/pq84/malaria/Pk_Malaysian_Population_Genetics/outputs/05_Analyses/rehh_geo/Mf_plots/iHS.png", dpi = 600, width = 10, iHS)
...
ggsave("/g/data/pq84/malaria/Pk_Malaysian_Population_Genetics/outputs/05_Analyses/rehh_geo/Mf_plots/iHS_pvalue.png", dpi = 600, width = 10, iHS_pvalue)

## Plotting using rehh

png('/g/data/pq84/malaria/Pk_Malaysian_Population_Genetics/outputs/05_Analyses/rehh_geo/Mf_plots/iHS_rehh.png')
manhattanplot(wgs_ihs, threshold = c(-10, 10))
dev.off()

png('/g/data/pq84/malaria/Pk_Malaysian_Population_Genetics/outputs/05_Analyses/rehh_geo/Mf_plots/iHS_p_rehh.png')
manhattanplot(wgs_ihs, pval = TRUE, threshold = 20)
dev.off()
...
ggsave("/g/data/pq84/malaria/Pk_Malaysian_Population_Genetics/outputs/05_Analyses/rehh_geo/Mf_plots/Rsb.png", dpi = 600, width = 10, Rsb_plot)
...
ggsave("/g/data/pq84/malaria/Pk_Malaysian_Population_Genetics/outputs/05_Analyses/rehh_geo/Mf_plots/Rsb_pvalue.png", dpi = 600, width = 10, Rsb_pvalue)
...
ggsave("/g/data/pq84/malaria/Pk_Malaysian_Population_Genetics/outputs/05_Analyses/rehh_geo/Mf_plots/XP_EHH.png", dpi = 600, width = 10, XP_EHH_plot)
...
ggsave("/g/data/pq84/malaria/Pk_Malaysian_Population_Genetics/outputs/05_Analyses/rehh_geo/Mf_plots/XP_EHH_pvalue.png", dpi = 600, width = 10, XP_EHH_pvalue)
