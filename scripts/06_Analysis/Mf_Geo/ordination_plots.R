...
ggsave("hmmIBD_Mf_Geo/Percentage_variance_explained.png", dpi=600, pve_plot)
...
ggsave("hmmIBD_Mf_Geo/PCA.png", dpi = 600, pca_plot)
...
ggsave("hmmIBD_Mf_Geo/MDS.png", dpi=600, mds_plot)
...
ggsave("hmmIBD_Mf_Geo/NJT_tree_cluster_rooted.png", dpi = 600, height = 8, width = 16, NJT_tree_plot)
...
ggsave("hmmIBD_Mf_Geo/NJT_tree_cluster_unrooted.png", dpi = 600, height = 15, width = 15, limitsize = FALSE, NJT_tree_plot)
...
ggsave("hmmIBD_Mf_Geo/NJT_tree_labelled_rooted.png", dpi = 600, height = 20, width = 20, limitsize = FALSE, NJT_tree_plot)