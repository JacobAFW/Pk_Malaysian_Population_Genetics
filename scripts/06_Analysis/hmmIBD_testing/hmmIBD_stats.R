...
# Seg SNPs for Mn
Pk.IBD <- read_table("Pk_subset_prop.hmm_fract.txt")
Pk.pairwise.median <- calculate.pairwise.matrix(Pk.IBD, metadata, "Cluster", median)
save.pairwise.matrix(Pk.pairwise.median, "seg_snp_outputs/Pk_subset_prop_IBD_pairwise_median.txt")

## stat summary
Pk.pairwise.summary <- calculate.pairwise.table(Pk.IBD, metadata, "Cluster", statistics)
save.pairwise.table(Pk.pairwise.summary, "seg_snp_outputs/Pk_subset_prop_pairwise_summary.txt")

# Seg SNPs for all clusters
Pk.IBD <- read_table("Pk_subset_all.hmm_fract.txt")
Pk.pairwise.median <- calculate.pairwise.matrix(Pk.IBD, metadata, "Cluster", median)
save.pairwise.matrix(Pk.pairwise.median, "seg_snp_outputs/Pk_subset_all_pairwise_IBD_median.txt")

## stat summary
Pk.pairwise.summary <- calculate.pairwise.table(Pk.IBD, metadata, "Cluster", statistics)
save.pairwise.table(Pk.pairwise.summary, "seg_snp_outputs/Pk_subset_all_pairwise_summary.txt")
