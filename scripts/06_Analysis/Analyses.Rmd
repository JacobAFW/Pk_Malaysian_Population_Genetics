...
library(tidyverse)
library(SeqArray)
seqVCF2GDS("moimix/PK_consensus_biallelic.vcf", "moimix/PK_consensus_filtered_pass.gds", storage.option = "LZ4_RA")
...
The regions we masked are here:
https://plasmodb.org/plasmo/service/users/current/steps/429386433/reports/attributesTabular
https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5918592/

and have to follow this format: https://www.cog-genomics.org/plink/1.9/input#make_set
